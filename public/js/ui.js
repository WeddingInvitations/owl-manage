...
export const ui = {
  ...
  processInvoicesBtn: $("processInvoicesBtn"),
  ...
  athletePaymentMethod: $("athletePaymentMethod"),
  ...
  // Clases Sueltas
  singleClassesView: $("singleClassesView"),
  singleClassesForm: $("singleClassesForm"),
  singleClassesName: $("singleClassesName"),
  singleClassesNameList: $("singleClassesNameList"),
  singleClassesPaymentMonth: $("singleClassesPaymentMonth"),
  singleClassesTariff: $("singleClassesTariff"),
  singleClassesPrice: $("singleClassesPrice"),
  singleClassesDiscount: $("singleClassesDiscount"),
  singleClassesDiscountReason: $("singleClassesDiscountReason"),
  singleClassesFinalPrice: $("singleClassesFinalPrice"),
  singleClassesPaid: $("singleClassesPaid"),
  singleClassesPaymentMethod: $("singleClassesPaymentMethod"),
  singleClassesModal: $("singleClassesModal"),
  singleClassesModalOpen: $("singleClassesModalOpen"),
  singleClassesModalClose: $("singleClassesModalClose"),
  singleClassesCsvModal: $("singleClassesCsvModal"),
  singleClassesCsvOpen: $("singleClassesCsvOpen"),
  singleClassesCsvClose: $("singleClassesCsvClose"),
  singleClassesCsvForm: $("singleClassesCsvForm"),
  singleClassesCsvFile: $("singleClassesCsvFile"),
  singleClassesCsvMonth: $("singleClassesCsvMonth"),
  singleClassesCsvStatus: $("singleClassesCsvStatus"),
  downloadSingleClassesTemplate: $("downloadSingleClassesTemplate"),
  singleClassesMonthSelect: $("singleClassesMonthSelect"),
  singleClassesListMonthSelect: $("singleClassesListMonthSelect"),
  singleClassesSummaryActive: $("singleClassesSummaryActive"),
  singleClassesSummaryAverage: $("singleClassesSummaryAverage"),
  singleClassesSummaryNew: $("singleClassesSummaryNew"),
  singleClassesSummaryDrop: $("singleClassesSummaryDrop"),
  singleClassesSearch: $("singleClassesSearch"),
  singleClassesSearchList: $("singleClassesSearchList"),
  singleClassesPaidFilter: $("singleClassesPaidFilter"),
  singleClassesSaveAllBtn: $("singleClassesSaveAllBtn"),
  singleClassesList: $("singleClassesList"),
  singleClassesListCount: $("singleClassesListCount"),
  
  // Pilates
  pilatesView: $("pilatesView"),
  pilatesForm: $("pilatesForm"),
  pilatesName: $("pilatesName"),
  pilatesNameList: $("pilatesNameList"),
  pilatesPaymentMonth: $("pilatesPaymentMonth"),
  pilatesTariff: $("pilatesTariff"),
  pilatesPrice: $("pilatesPrice"),
  pilatesDiscount: $("pilatesDiscount"),
  pilatesDiscountReason: $("pilatesDiscountReason"),
  pilatesFinalPrice: $("pilatesFinalPrice"),
  pilatesPaid: $("pilatesPaid"),
  pilatesPaymentMethod: $("pilatesPaymentMethod"),
  pilatesModal: $("pilatesModal"),
  pilatesModalOpen: $("pilatesModalOpen"),
  pilatesModalClose: $("pilatesModalClose"),
  pilatesCsvModal: $("pilatesCsvModal"),
  pilatesCsvOpen: $("pilatesCsvOpen"),
  pilatesCsvClose: $("pilatesCsvClose"),
  pilatesCsvForm: $("pilatesCsvForm"),
  pilatesCsvFile: $("pilatesCsvFile"),
  pilatesCsvMonth: $("pilatesCsvMonth"),
  pilatesCsvStatus: $("pilatesCsvStatus"),
  downloadPilatesTemplate: $("downloadPilatesTemplate"),
  pilatesMonthSelect: $("pilatesMonthSelect"),
  pilatesListMonthSelect: $("pilatesListMonthSelect"),
  pilatesSummaryActive: $("pilatesSummaryActive"),
  pilatesSummaryAverage: $("pilatesSummaryAverage"),
  pilatesSummaryNew: $("pilatesSummaryNew"),
  pilatesSummaryDrop: $("pilatesSummaryDrop"),
  pilatesSearch: $("pilatesSearch"),
  pilatesSearchList: $("pilatesSearchList"),
  pilatesPaidFilter: $("pilatesPaidFilter"),
  pilatesNameSortHeader: $("pilatesNameSortHeader"),
  pilatesSaveAllBtn: $("pilatesSaveAllBtn"),
  pilatesList: $("pilatesList"),
  pilatesListCount: $("pilatesListCount"),
  ...
  acroPaid: $("acroPaid"),
  acroPaymentMethod: $("acroPaymentMethod"),
  acroModal: $("acroModal"),
  ...
  // AcroKids
  acroKidsForm: $("acroKidsForm"),
  acroKidsName: $("acroKidsName"),
  acroKidsNameList: $("acroKidsNameList"),
  acroKidsPaymentMonth: $("acroKidsPaymentMonth"),
  acroKidsTariff: $("acroKidsTariff"),
  acroKidsPrice: $("acroKidsPrice"),
  acroKidsDiscount: $("acroKidsDiscount"),
  acroKidsDiscountReason: $("acroKidsDiscountReason"),
  acroKidsFinalPrice: $("acroKidsFinalPrice"),
  acroKidsPaid: $("acroKidsPaid"),
  acroKidsPaymentMethod: $("acroKidsPaymentMethod"),
  acroKidsModal: $("acroKidsModal"),
  acroKidsModalOpen: $("acroKidsModalOpen"),
  acroKidsModalClose: $("acroKidsModalClose"),
  acroKidsCsvModal: $("acroKidsCsvModal"),
  acroKidsCsvOpen: $("acroKidsCsvOpen"),
  acroKidsCsvClose: $("acroKidsCsvClose"),
  acroKidsCsvForm: $("acroKidsCsvForm"),
  acroKidsCsvFile: $("acroKidsCsvFile"),
  acroKidsCsvMonth: $("acroKidsCsvMonth"),
  acroKidsCsvStatus: $("acroKidsCsvStatus"),
  downloadAcroKidsTemplate: $("downloadAcroKidsTemplate"),
  acroKidsMonthSelect: $("acroKidsMonthSelect"),
  acroKidsListMonthSelect: $("acroKidsListMonthSelect"),
  acroKidsSummaryActive: $("acroKidsSummaryActive"),
  acroKidsSummaryAverage: $("acroKidsSummaryAverage"),
  acroKidsSummaryNew: $("acroKidsSummaryNew"),
  acroKidsSummaryDrop: $("acroKidsSummaryDrop"),
  acroKidsSearch: $("acroKidsSearch"),
  acroKidsSearchList: $("acroKidsSearchList"),
  acroKidsPaidFilter: $("acroKidsPaidFilter"),
  acroKidsSaveAllBtn: $("acroKidsSaveAllBtn"),
  acroKidsList: $("acroKidsList"),
  acroKidsListCount: $("acroKidsListCount"),
  acroKidsCalendarOpen: $("acroKidsCalendarOpen"),
  acroKidsCalendarView: $("acroKidsCalendarView"),
  acroKidsCalendar: $("acroKidsCalendar"),
  acroKidsCalendarModal: $("acroKidsCalendarModal"),
  acroKidsCalendarCloseBtn: $("acroKidsCalendarCloseBtn"),
  acroKidsCalendarBackBtn: $("acroKidsCalendarBackBtn"),
  acroKidsCalendarTodayBtn: $("acroKidsCalendarTodayBtn"),
  acroKidsCalendarSelectedDateLabel: $("acroKidsCalendarSelectedDateLabel"),
  acroKidsCalendarSelectedSlotLabel: $("acroKidsCalendarSelectedSlotLabel"),
  acroKidsCalendarChildName: $("acroKidsCalendarChildName"),
  acroKidsCalendarAddChildBtn: $("acroKidsCalendarAddChildBtn"),
  acroKidsCalendarHelp: $("acroKidsCalendarHelp"),
  acroKidsCalendarChildrenList: $("acroKidsCalendarChildrenList"),
  acroKidsCalendarSummaryBtn: $("acroKidsCalendarSummaryBtn"),
  acroKidsCalendarSummaryModal: $("acroKidsCalendarSummaryModal"),
  acroKidsCalendarSummaryCloseBtn: $("acroKidsCalendarSummaryCloseBtn"),
  acroKidsCalendarSummaryTableBody: $("acroKidsCalendarSummaryTableBody"),
  // Halterofilia
  halteForm: $("halteForm"),
  halteName: $("halteName"),
  halteNameList: $("halteNameList"),
  haltePaymentMonth: $("haltePaymentMonth"),
  halteTariff: $("halteTariff"),
  haltePrice: $("haltePrice"),
  halteDiscount: $("halteDiscount"),
  halteDiscountReason: $("halteDiscountReason"),
  halteFinalPrice: $("halteFinalPrice"),
  haltePaid: $("haltePaid"),
  haltePaymentMethod: $("haltePaymentMethod"),
  halteModal: $("halteModal"),
  halteModalOpen: $("halteModalOpen"),
  halteModalClose: $("halteModalClose"),
  halteCsvModal: $("halteCsvModal"),
  halteCsvOpen: $("halteCsvOpen"),
  halteCsvClose: $("halteCsvClose"),
  halteCsvForm: $("halteCsvForm"),
  halteCsvFile: $("halteCsvFile"),
  halteCsvMonth: $("halteCsvMonth"),
  halteCsvStatus: $("halteCsvStatus"),
  downloadHalteTemplate: $("downloadHalteTemplate"),
  halteMonthSelect: $("halteMonthSelect"),
  halteListMonthSelect: $("halteListMonthSelect"),
  halteSummaryActive: $("halteSummaryActive"),
  halteSummaryAverage: $("halteSummaryAverage"),
  halteSummaryNew: $("halteSummaryNew"),
  halteSummaryDrop: $("halteSummaryDrop"),
  halteSearch: $("halteSearch"),
  halteSearchList: $("halteSearchList"),
  haltePaidFilter: $("haltePaidFilter"),
  halteSaveAllBtn: $("halteSaveAllBtn"),
  halteList: $("halteList"),
  halteListCount: $("halteListCount"),
  // Telas
  telasForm: $("telasForm"),
  telasName: $("telasName"),
  telasNameList: $("telasNameList"),
  telasPaymentMonth: $("telasPaymentMonth"),
  telasTariff: $("telasTariff"),
  telasPrice: $("telasPrice"),
  telasDiscount: $("telasDiscount"),
  telasDiscountReason: $("telasDiscountReason"),
  telasFinalPrice: $("telasFinalPrice"),
  telasPaid: $("telasPaid"),
  telasPaymentMethod: $("telasPaymentMethod"),
  telasModal: $("telasModal"),
  telasModalOpen: $("telasModalOpen"),
  telasModalClose: $("telasModalClose"),
  telasCsvModal: $("telasCsvModal"),
  telasCsvOpen: $("telasCsvOpen"),
  telasCsvClose: $("telasCsvClose"),
  telasCsvForm: $("telasCsvForm"),
  telasCsvFile: $("telasCsvFile"),
  telasCsvMonth: $("telasCsvMonth"),
  telasCsvStatus: $("telasCsvStatus"),
  downloadTelasTemplate: $("downloadTelasTemplate"),
  telasMonthSelect: $("telasMonthSelect"),
  telasListMonthSelect: $("telasListMonthSelect"),
  telasSummaryActive: $("telasSummaryActive"),
  telasSummaryAverage: $("telasSummaryAverage"),
  telasSummaryNew: $("telasSummaryNew"),
  telasSummaryDrop: $("telasSummaryDrop"),
  telasSearch: $("telasSearch"),
  telasSearchList: $("telasSearchList"),
  telasPaidFilter: $("telasPaidFilter"),
  telasSaveAllBtn: $("telasSaveAllBtn"),
  telasList: $("telasList"),
  telasListCount: $("telasListCount"),
